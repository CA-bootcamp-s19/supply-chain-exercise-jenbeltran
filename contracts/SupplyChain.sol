...
contract SupplyChain {
  ...
  */
  //State.ForSale, State.Sold, State.Shipped etc.
  ...
  */
  //items[sku].name, items[sku].sku, items[sku].price...etc
  struct Item { 
      string name;
      uint sku;
      uint price;
...
modifier isOwner() { 
  ...
  that the item with the given sku has the state ForSale. Note that the uninitialized Item.State is 0, which is also the index of the ForSale value,
